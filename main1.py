...
menu_prompt = PromptTemplate(
    ...
    template="Suggest 5 menu items for {restaurant_name}. Return as comma separated list."
)
...
menu_prompt = PromptTemplate(
    input_variables=["cuisine"],
    template="Suggest 5 popular dishes for {cuisine} cuisine. Return comma separated list."
)
